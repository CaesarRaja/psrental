...
@section('content')
    ...
    <div class="dashboard-card">
        <div class="card-header-custom">
            <h5><i class="fas fa-user-edit me-2"></i>Data Customer</h5>
        </div>
        <div class="card-body-custom">
            <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" id="customerEditForm">
                @csrf
                @method('POST')
                ...
                <div class="card-header-custom ps-0">
                    <h5><i class="fas fa-lock me-2"></i>Reset Password</h5>
